<div>
        ...
        <div class="flex space-x-4">
            ...
            @if ($verStripping)
                <button class="flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
                    ...
                    <a href="{{ route('stripping', ['paciente'=> $paciente->id, 'tipo' => 'stripping']) }}"><span> Ver Stripping</span></a>
                </button>
            @endif
            <!-- Botón Editar-->
                ...
                <div class="w-full md:w-9/12 mx-2 rounded-lg">
                    ...
                    <div class="bg-white p-5 shadow-lg rounded-lg space-y-6">
                        ...
                        <div class="space-y-8">
                            ...
                            <!-- Mostrar etapas paginadas de cada tratamiento -->
                                <div class="grid grid-cols-1 gap-6 items-start border-t pt-4">
                                    <!-- Tratamiento -->
                                    <div class="space-y-2">
                                        <a href="{{ route('paciente-historial', ['id'=>$paciente->id, 'tratId' => $tratamiento->id]) }}" class="text-teal-600 font-semibold text-lg cursor-pointer">
    ...
    @if ($showModalPaciente)
        <x-dialog-modal maxWidth="lg" wire:model="showModalPaciente">
            <div class="relative">
                <x-slot name="title">
                    <div class="flex justify-between items-center">
