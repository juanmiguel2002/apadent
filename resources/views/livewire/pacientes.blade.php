                            ...
                            <form wire:submit.prevent="save">
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="col-span-2 sm:col-span-1 mb-4">
                                        ...
                                        <x-input type="date" id="revision" class="w-full rounded-md" wire:model="revision" />
                                    ...
                                    <div class="col-span-2 mb-4">
                                        ...
                                        <x-input multiple wire:model="cbcts" type="file" class="block w-full px-3 py-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" />
