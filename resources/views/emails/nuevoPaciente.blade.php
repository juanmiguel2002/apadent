                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td class="content-cell" style="box-sizing: border-box; max-width: 100vw; padding: 32px;">
                                        ...
                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            Se ha registrado un nuevo paciente en la clínica.
                                        </p>

                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            <strong>Paciente:</strong> {{$pacienteName}} {{$pacienteApellidos}}
                                        </p>
                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            <strong>Email:</strong> {{$pacienteEmail}}
                                        </p>
                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            <strong>Teléfono:</strong> {{$pacienteTelefono}}
                                        </p>
                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            <strong>Fecha Nacimiento:</strong> {{$pacienteFechaNacimiento}}
                                        </p>
                                        {{-- <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                        ...
                                        <p style="box-sizing: border-box; font-size: 16px; line-height: 1.5em; margin-top: 0;">
                                            <strong>Registrado por:</strong> {{$fechaRegistro}}
                                        </p>
